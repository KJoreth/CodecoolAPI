namespace CodecoolMaterialsAPI.Data.Seeder.EntitiesSeeders.Seeders
{
    public static class MaterialsSeeder
    {
        public static void SeedMaterials(this ModelBuilder builder)
        {
            ...
            string[] fileLines = File.ReadAllLines("../CodecoolMaterialAPI.Data/Seeder/EntitiesSeeders/Data/Materials.txt");
        ...
        private static Material GetItemFromLine(string line)
        {
            ...
            return new Material() { Id = id, Title = title, Location = location, 
                PublishDate = dateTime, AuthorId = authorId, TypeId = typeId };
        }
    }
}
